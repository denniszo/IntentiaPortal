    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2px">
        ...
        -->
                ...
                <table>
                    ...
                    <td>
                        <div style="width: 100px;">
                            <select id="ddlType" onchange="ddlTypeChanged();">
            ...
            <td>
                ...
                onclick="btnShowRecon()"><%=btnShow%></button>
            </td>
            <td>
                <button type="button" class="btn btn-info" id="btnCommit"
                       onclick="btnDoRecon()"><%=btnCommit%></button>
            </td>
        ...
        <tr>
            ...
            <td>
                <table>
                    <td>
                        <select id="ddlFrom" class="dropdown">
                           ...
                           <!-- <option value="ABS(BDBLAM);ABS(FG.EGCUAM)"><%=str_amount%></option>-->
                            <option value="BDBLAM;FG.EGCUAM"><%=str_amount%></option>
            ...
            <!-- buttons -->
            <td colspan="2">
                <button  type="button" class="btn btn-warning" onclick="btnRedistRec();"
                       id="btnReg"><%=Registration%></button >
            </td>
...
<div style="margin: 10px;direction: <%=direction%>;">
    ...
    <!-- Modal Wait prosents-->
    <div class="modal fade" id="dlgWaitProsent" tabindex="-1" role="dialog" aria-labelledby="dlgWaitProsentLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="dlgWaitProsentLabel">Please Wait</h4>
                </div>
    ...
    <!-- go to dlgREGIST-->
    <div id="dlgREGIST" stile="width=100%;"/>
