...
%>
<P align="center"><B><FONT size="+2"><%=title_stop%></FONT></B></P>
<P><BR>
<BR>
</P>
<DIV align="center">
<FORM name = "myForm" action="mwsfPMS420_StopWorkOp.jsp" target="RepManWin" method="POST">
<TABLE border="0">
	<TBODY align="center">
		<TR>
